...
public final class AsciiFont {
    ...
    private AsciiFont(Map<Character,List<String>> g, int h, int gap){
        this.glyphs = g; this.height = h; this.gap = gap;
    }
    public int height(){ return height; }
    public int gap(){ return gap; }
    public List<String> glyph(char ch){ return glyphs.getOrDefault(Character.toUpperCase(ch), glyphs.getOrDefault('?', List.of("?" ))); }
    ...
    public static final class Builder {
        ...
        public Builder gap(int gpx){ this.gap = gpx; return this; }
        public Builder put(char c, List<String> lines){ g.put(Character.toUpperCase(c), List.copyOf(lines)); return this; }
