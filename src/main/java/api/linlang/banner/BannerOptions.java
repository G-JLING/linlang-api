...
public record BannerOptions(
    ...
    public static final class Builder {
        ...
        public Builder developers(List<String> devs){ developers = List.copyOf(devs); return this; }

        public BannerOptions build(){ return new BannerOptions(initials,teamZh,teamEn,seriesZh,seriesEn,pluginZh,pluginEn,version,developers,site); }
    }
}