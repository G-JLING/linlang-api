 ...
 * <p>您正在阅读琳琅开发者接口文档。开发者接口文档是面向熟悉 Java 的专业开发者，帮助其了解该项目开放的代码接口的文档，其不能帮助您学习使用 Java 或编程。如果您想知道如何快速使用琳琅进行开发，请阅读 <a href="https://jling.me/linlang"> 琳琅 </a> 页面。</p>
 *
...
module linlang.api {
    ...
    exports api.linlang.file.file.config;
